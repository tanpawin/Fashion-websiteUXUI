    ...
    return (
        <main className="min-h-screen bg-white text-zinc-900">
            <div className="container mx-auto px-4 py-12 md:py-20">
                <Link
                    href="/"
                    className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.25em] text-zinc-400 hover:text-zinc-900 transition-colors mb-12 md:mb-16"
                >
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col justify-center">
                        ...
                        <div className="border-t border-zinc-200 pt-8 mb-8">
                            ...
                            <p className="text-xs text-zinc-400 mt-2 tracking-wide">
                                ราคาอ้างอิงสำหรับการแสดงผล — ไม่มีการขายสินค้าผ่านเว็บไซต์นี้
                            </p>
                        </div>
            ...
            <footer>
                <div className="container mx-auto px-4 py-8 border-t border-zinc-100">
